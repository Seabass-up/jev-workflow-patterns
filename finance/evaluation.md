...
- [Initial 32 receipts]({{ '/finance/results/screening.json' | relative_url }})
- [Recovery receipts]({{ '/finance/results/recovery.json' | relative_url }})
- [Exact summary]({{ '/finance/results/summary.json' | relative_url }})
- [Frozen question catalog]({{ '/finance/catalog.json' | relative_url }}) and [32 fixtures]({{ '/finance/fixtures.json' | relative_url }})
- [Offline evaluator](https://github.com/Seabass-up/jev-workflow-patterns/blob/main/finance/evaluate.py) and [regression tests](https://github.com/Seabass-up/jev-workflow-patterns/blob/main/finance/test_evaluate.py)
- [Source support review]({{ '/finance/results/source-review.json' | relative_url }})

Run from the repository root with Python 3:

```sh
python3 finance/evaluate.py
python3 -m unittest discover -s finance -p 'test_*.py' -v
```
...
Successful fixture responses report 21,649 input tokens and 1,802 output tokens. The local bridge estimates their total cost at $0.000909258. That is an estimate, not an invoice, and excludes design-review calls and any billing for failed calls.
...
[Back to the collection]({{ '/finance/' | relative_url }})
